...
class systemtrade:
    ...
    def __init__(self, key_name, secret_name, ID, mock, cano): # NOTE: 계좡 지정가능. 
        # API Key
        ...
        # base url
        #self.url_base = "https://openapivts.koreainvestment.com:29443" # 모의투자
        #self.url_base = "https://openapi.koreainvestment.com:9443" #실전
        ...
        self.access_token_expired = res.json()['access_token_expired']
    ...
    def check_account(self):
        ...
        while True:
            ...
            headers = {
                ...
                "appKey": self.app_key,
                "appSecret": self.app_secret,
                "tr_id": "TTTC8434R" #"VTTC8434R" 모의 #TTTC8434R : 실전주식 잔고 조회
            }
    ...
    def rebalancing_trade_at_once(self):
        ...
        for t in range(target_day.shape[0]) :        
            ...
            position = 'VTTC0802U' if n > 0 else 'VTTC0801U' # Sell: VTTC0802U or Buy: VTTC0802U
            ticker = target_day.loc[t, '종목코드']                # Define ticker 
            schedule.every().day.at(time_list_sec[t],"Asia/Seoul").do(self.trading_at_once, ticker, position, "03",n) # 03: 최유리
        return schedule
